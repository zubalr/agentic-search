...
if __name__ == "__main__":
    # Delete comparison memory file if it exists (start fresh)
    if os.path.exists(COMPARISON_MEMORY_FILE):
        print(f"Deleting old comparison memory file: {COMPARISON_MEMORY_FILE}")
        os.remove(COMPARISON_MEMORY_FILE)
    asyncio.run(main())